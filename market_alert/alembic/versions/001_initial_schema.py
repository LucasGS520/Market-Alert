...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            postgresql.ENUM("competitive", "attention", "urgent", name="comparison_status", create_type=False),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "channel",
            postgresql.ENUM("ntfy", "telert", name="notification_channel", create_type=False),
            nullable=False,
        ),
