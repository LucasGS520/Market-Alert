"""
Modelo ORM: produto monitorado.

Um MonitoredProduct representa um produto que o usuário deseja acompanhar.
Ele tem uma URL alvo, mantém o preço e disponibilidade mais recentes,
e controla quando a próxima coleta deve ocorrer.

Relações:
    competitors      → até 5 concorrentes vinculados a este produto
    price_history    → histórico de todos os preços coletados
    comparisons      → histórico de análises competitivas calculadas
...
class MonitoredProduct(Base):
    ...
    # Controle de agendamento das coletas
    ...
    # Contador de coletas consecutivas sem mudança de preço (usado pelo intervalo adaptativo)
